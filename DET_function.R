DET_plot = function(LR.H1.exp, LR.H2.exp, title="")
{
  ...
  plot(main=title, x, y, type="S", xlab="false positives [%]", ylab="false negatives [%]", xaxt="n", yaxt="n", xlim=c(qnorm(0.0001),qnorm(0.5)), ylim=c(qnorm(0.0001),qnorm(0.5)))
